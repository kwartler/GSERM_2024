...
# Data Folder
folderPaths <- list.dirs(path = '~/Desktop/GSERM_2024/lessons/Day5_supervised_unsupervised/data/AutoAndElectronics')
savePath <- '~/Desktop/GSERM_2024/lessons/Day5_supervised_unsupervised/data/'
...
# Make TDM; lsa docs say DTM w/"documents in columns, terms in rows and occurrence frequencies in the cells."!
...
lsaTDM <- readRDS(paste0(savePath, '2024-06-09_lsaTDM_tfidf_.rds'))
