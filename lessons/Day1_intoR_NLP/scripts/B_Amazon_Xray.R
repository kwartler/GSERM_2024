...
# Force Awakens
# 'https://raw.githubusercontent.com/kwartler/GSERM_2024/main/lessons/Day1_intoR_NLP/data/forceAwakens_definedScenes.csv'

# Lego Movie
# 'https://raw.githubusercontent.com/kwartler/GSERM_2024/main/lessons/Day1_intoR_NLP/data/lego_definedScenes.csv'

# Mary Poppins
# https://raw.githubusercontent.com/kwartler/GSERM_2024/main/lessons/Day1_intoR_NLP/data/poppins_definedScenes.csv

# URL to the file
movieURL <- 'https://raw.githubusercontent.com/kwartler/GSERM_2024/main/lessons/Day1_intoR_NLP/data/lego_definedScenes.csv'
