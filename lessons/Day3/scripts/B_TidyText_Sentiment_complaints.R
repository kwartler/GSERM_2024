...
# Data list.files()
filePathA <- 'https://raw.githubusercontent.com/kwartler/GSERM_2024/main/lessons/Day3/data/goldmanSachs_2023_3k.csv'
filePathB <- 'https://raw.githubusercontent.com/kwartler/GSERM_2024/main/lessons/Day3/data/BARCLAYS_BANK_DELAWARE_2023_3k.csv'
