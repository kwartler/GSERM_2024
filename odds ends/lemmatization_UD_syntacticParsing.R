...
# Inputs
datPth          <- 'https://raw.githubusercontent.com/kwartler/UNC_summer2023/main/lessons/E_syntaticParsing_AI-Ethics/data/tweets_jairbolsonaro.csv'
testing         <- T
nonBasicStops   <- c('segura', 'seguro')
folderPath      <- '~/Desktop/GSERM_2024/personalFiles/'
