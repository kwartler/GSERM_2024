...
# Data
if(testing == T){
  unknownLanguageOne <- read.csv("https://raw.githubusercontent.com/kwartler/hult_NLP_student/d939ab941cc46b0af3e160c8af7ae98863708b27/lessons/class7/data/tweets_Haddad_Fernando.csv", 
                                 nrows = 100)
} else {
  unknownLanguageOne <- read.csv("https://raw.githubusercontent.com/kwartler/hult_NLP_student/d939ab941cc46b0af3e160c8af7ae98863708b27/lessons/class7/data/tweets_Haddad_Fernando.csv")
