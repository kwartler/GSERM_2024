...
#saveRDS(nlpResult,'~/Desktop/GSERM_2024/personalFiles/nlpResult.rds')
...
#saveRDS(translatedTxt, '~/Desktop/GSERM_2024/personalFiles/translatedTxt.rds')
#translatedTxt <- readRDS('translatedTxt.rds')
translatedTxt$translatedText

#### Speech to Text
#http://www.voiptroubleshooter.com/open_speech/american.html
speechToTxt <- gl_speech('~/Desktop/GSERM_2024/lessons/Day3_sentiment/data/trimmed.wav', sampleRateHertz = 8000)
#saveRDS(speechToTxt, '~/Desktop/GSERM_2024/personalFiles/speechToTxt.rds')
